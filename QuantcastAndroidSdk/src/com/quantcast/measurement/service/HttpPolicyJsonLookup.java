...
class HttpPolicyJsonLookup implements PolicyJsonLookup {
    ...
    public HttpPolicyJsonLookup(String apiKey, String apiVersion) {
        policyRequestURL = generatePolicyRequestURL(apiKey, apiVersion);
        httpClient = new DefaultHttpClient();
    }
    
    public HttpPolicyJsonLookup(String apiKey, String apiVersion, HttpClient httpClient) {
        policyRequestURL = generatePolicyRequestURL(apiKey, apiVersion);
    ...
    public static final String generatePolicyRequestURL(String apiKey, String apiVersion) {
        Uri.Builder builder = Uri.parse(QuantcastServiceUtility.addScheme(POLICY_REQUEST_BASE_WITHOUT_SCHEME)).buildUpon();
